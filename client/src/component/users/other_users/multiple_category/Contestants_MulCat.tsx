...
import { Box, Button, Fab, Grid, Grow, IconButton, InputBase, Tooltip, Typography, Snackbar, Zoom, Pagination, Avatar, Backdrop, Fade, CircularProgress } from '@mui/material';
...
import AddContestants_MulCat from './AddContestants_MulCat';
...
export default function Contestants_SingCat({activateAll, deActivateAll, activate, msgLoad}:Props) {
    ...
    >
      ...
      >
            ...
            <Table sx={{ width: "100%" }} aria-label="simple table">
              <TableHead>
                <TableRow sx={{backgroundColor: "#8A809C"}}>
                  ...
                  <TableCell align="center"><span style={{fontWeight: "bolder", color: "#5B4D75"}}>|</span>&nbsp;Category</TableCell>
              ...
              {Object.values(currItems).map((data: any, index: number) => (
                  ...
                  >
                    ...
                    <TableCell align="center">{data.category.toUpperCase()}</TableCell>
        ...
        >
          ...
          >
            <AddContestants_MulCat closeDialog={closeDialog}/>
          </DialogContent>
        </Dialog>
      </Grid>
    </Grid>
